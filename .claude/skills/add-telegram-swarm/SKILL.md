...
In any group CLAUDE.md that has a "Message Formatting" section (e.g. `groups/main/CLAUDE.md`), rename the heading to reflect multi-channel support:

```
## Message Formatting (for messaging apps)
```
