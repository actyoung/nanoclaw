---
name: add-telegram
description: Add Telegram as a channel. Can run alongside Feishu or replace it as the main channel. Also configurable as a control-only channel (triggers actions) or passive channel (receives notifications only).
---
