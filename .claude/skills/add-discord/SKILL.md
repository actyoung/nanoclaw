...
AskUserQuestion: Should Discord replace Feishu or run alongside it?
- **Replace Feishu** - Discord will be the only channel (sets DISCORD_ONLY=true)
- **Alongside** - Both Discord and Feishu channels active
