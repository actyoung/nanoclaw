---
name: add-slack
description: Add Slack as a channel. Can run alongside Feishu or replace it as the main channel. Uses Socket Mode (no public URL needed).
---
...
- **Multi-channel** — Can run alongside Feishu or other channels (auto-enabled by credentials)
